...
## Project Structure
    ...
    ├── testapiautoconnect_115838  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_115838`
...
2. Clone this repo and `cd testapiautoconnect_115838`
